    ...
    return (
      <div className="min-h-screen pt-16 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Art Form Not Found</h1>
          <Link to="/who-are-you" className="text-purple-600 hover:text-purple-700">
            ← Back to Art Forms
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url(${artForm.image})`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Discover the Art of {artForm.name}</h2>
            ...
            {/* Video Section */}
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Featured Workshop</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Students Enrolled</p>
                    <p className="text-sm text-gray-600">2,847 active learners</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">24 comprehensive modules</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
            ...
            {/* CTA */}
            <div className={`${artForm.gradient} rounded-2xl p-6 text-center`}>
              ...
              <div className="space-y-3">
                {artForms.filter(form => form.id !== artForm.id).slice(0, 3).map((relatedForm) => (
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className="font-medium text-gray-900">{relatedForm.name}</p>
                      <p className="text-sm text-gray-600 truncate">{relatedForm.description}</p>
                    </div>
                  </Link>
                ))}
              </div>
