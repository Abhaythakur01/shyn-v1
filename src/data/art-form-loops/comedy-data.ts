export const legendaryComics: { id: string; name: string; style: string; image: string; bio: string; videos?: string[] }[] = [
  {
    id: '1',
    name: 'George Carlin',
    style: 'Observational, Satire, Black Comedy',
    image: '/images/comics/george-carlin.jpeg',
    bio: 'A master of observational and black comedy, Carlin was known for his critical views on politics, religion, and modern life. His "seven dirty words" routine became legendary.',
    videos: ['https://www.youtube.com/watch?v=MK2W2cyAzLI']
  },
  {
    id: '2',
    name: 'Richard Pryor',
    ...
    videos: ['https://www.youtube.com/watch?v=1tNRcQ9WU70']
  },
  {
    id: '3',
    name: 'Dave Chappelle',
    ...
    videos: ['https://www.youtube.com/watch?v=pvc_XDDrwgc']
  },
  {
    id: '4',
    name: 'Vir Das',
    ...
    videos: ['https://www.youtube.com/watch?v=10']
  },
  {
    id: '5',
    name: 'Zakir Khan',
    ...
    videos: ['https://www.youtube.com/watch?v=11']
  },
  {
    id: '6',
    name: 'Norm Macdonald',
    ...
    videos: ['https://www.youtube.com/watch?v=BFulaWVKV6s']
  },
  {
    id: '7',
    ...
    videos: ['https://www.youtube.com/watch?v=13']
  },
  {
    id: '8',
    ...
    videos: ['https://www.youtube.com/watch?v=14']
  },
  {
    id: '9',
    name: 'John Cleese',
    ...
    videos: ['https://img.youtube.com/vi/$4']
  },
  {
    id: '10',
    name: 'Robin Williams',
    ...
    videos: ['https://img.youtube.com/vi/$5']
  },
  {
    id: '11',
    ...
    videos: ['https://img.youtube.com/vi/$6']
  },
  {
    id: '12',
    name: 'Trevor Noah',
    ...
    videos: ['https://img.youtube.com/vi/$7']
  },
  {
    id: '13',
    name: 'Daniel Sloss',
    ...
    videos: ['https://img.youtube.com/vi/$8']
  },
  {
    id: '14',
    name: 'Bill Burr',
    ...
    videos: ['https://img.youtube.com/vi/$9']
  },
  {
    id: '15',
    name: 'Ali Wong',
    ...
    videos: ['https://www.youtube.com/watch?v=Ki6G_LUOQq40']
  },
  {
    id: '16',
    ...
    videos: ['https://www.youtube.com/watch?v=Ki6G_LUOQq41']
  },
  {
    id: '17',
    name: 'Hannah Gadsby',
    ...
    videos: ['https://www.youtube.com/watch?v=Ki6G_LUOQq42']
  },
  {
    id: '18',
    ...
    videos: ['https://www.youtube.com/watch?v=Ki6G_LUOQq43']
  },
  {
    id: '19',
    name: 'Patton Oswalt',
    ...
    videos: ['https://www.youtube.com/watch?v=Ki6G_LUOQq44']
  }
];